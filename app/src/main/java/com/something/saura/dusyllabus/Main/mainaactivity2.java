...
import com.something.saura.dusyllabus.Ba.Sem1.subofsem1ba;
import com.something.saura.dusyllabus.Ba.sem2.subofsem2ba;
import com.something.saura.dusyllabus.Ba.sem3.subofsem3ba;
...
public class mainaactivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int1=new Intent(getApplicationContext(),subofsem1ba.class);
                startActivity(int1);
            }
        });
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int2=new Intent(getApplicationContext(),subofsem2ba.class);
                startActivity(int2);
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int3=new Intent(getApplicationContext(),subofsem3ba.class);
                startActivity(int3);
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id==R.id.id_more){
            Intent intmore=new Intent(mainaactivity2.this,more.class);
