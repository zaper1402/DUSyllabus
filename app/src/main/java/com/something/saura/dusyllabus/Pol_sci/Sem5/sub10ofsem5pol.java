...
public class sub10ofsem5pol extends AppCompatActivity {
    private AdView mAdView;     private SpannableStringBuilder text = new SpannableStringBuilder();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.syllabus_page);
        String file = "sub10ofsem5pol.txt";
